		...
		public static void main(String[] args) {
			...
			try{
			 while(cursor.hasNext()){
				 ...
				 String durl="http://beijing.anjuke.com/ajax/communityext/?useflg=onlyForAjax&commid="+uid.toString();
//				 System.out.println(durl);
				 ...
				 if(html.contains("saleNum")){
					 ...
					 records.put("id","http://beijing.anjuke.com/community/view/"+uid);
					 records.put("uid",uid);
					 mongo.upsertMapByTableName(records, "ajk_beijing_community_information");
					 doc.append("crawl_rent", "1");
					 mongo.upsertDocByTableName(doc, "ajk_beijing_community_name");
				 }else {
