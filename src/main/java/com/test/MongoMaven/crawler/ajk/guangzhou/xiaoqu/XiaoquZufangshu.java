package com.test.MongoMaven.crawler.ajk.guangzhou.xiaoqu;
...
public class XiaoquZufangshu {
		...
		public static void main(String[] args) {
			 ...
			 while(cursor.hasNext()){
				 ...
				 String durl="http://guangzhou.anjuke.com/ajax/communityext/?useflg=onlyForAjax&commid="+uid.toString();
//				 System.out.println(durl);
				 ...
				 if(html.contains("saleNum")){
					 ...
					 records.put("id","http://guangzhou.anjuke.com/community/view/"+uid);
					 records.put("uid",uid);
					 mongo.upsertMapByTableName(records, "ajk_guangzhou_community_information");
					 doc.append("crawl_rent", "1");
					 mongo.upsertDocByTableName(doc, "ajk_guangzhou_community_name");
//					 System.exit(1);
				 }else {
