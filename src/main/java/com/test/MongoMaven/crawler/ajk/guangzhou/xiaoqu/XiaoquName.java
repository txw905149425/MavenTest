...
public class XiaoquName {
	 public static void main(String[] args) {
		 ...
		 String furl="https://www.anjuke.com/guangzhou/cm/p1/";
		...
		try{
			for(int i=8;i<num;i++){
				...
				for(int j=1;j<=35;j++){
//				 String url="https://www.anjuke.com/guangzhou/cm/p"+j+"/";
				 ...
				 try {
					mongo.upsetManyMapByTableName(list, "ajk_guangzhou_community_name");
				} catch (Exception e) {
	 ...
	 public static  List<HashMap<String, Object>>  parseList(String html){
			...
			for(int i=0;i<num;i++){
				...
				String url="http://guangzhou.anjuke.com/community/view/"+uid;
				map.put("id", name);
				map.put("url", url);
				map.put("uid", uid);
				list.add(map);
