package com.test.MongoMaven.crawler.ajk.shanghai.fangzi.durl;
...
import com.test.MongoMaven.crawler.ajk.shanghai.fangzi.one.ParseMethod;
 ...
 * 新浪股吧
 * */
public class ShanghaiCrawleByDurl {
			 ...
			 while(cursor.hasNext()){
				 ...
				 if(resultmap.isEmpty()){
					...
					if(!StringUtil.isEmpty(html)&&ParseMethod.htmlFilter(html, ".wrapper>div>h3")){
						 ...
						 map.put("id", url);
						 map.put("crawl", "1");
						mongo.upsertMapByTableName(map, "ajk_shanghai_detail_url");
