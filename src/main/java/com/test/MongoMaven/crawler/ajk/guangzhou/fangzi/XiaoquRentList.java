package com.test.MongoMaven.crawler.ajk.guangzhou.fangzi;
...
public class XiaoquRentList {
	public static void main(String[] args) {
		 ...
		 MongoCollection<Document>  collection=mongo.getShardConn("ajk_guangzhou_community_information");
...
//			 Object name=doc.get("community_name");
		     ...
		     for(int i=1;i<=page;i++){
		    	...
		    	String url="http://guangzhou.anjuke.com/community/props/rent/"+uid+"/p"+i;
		    	rec.put("id", url) ;
		    	rec.put("uid", uid) ;
		    	mongo.upsertMapByTableName(rec, "ajk_guangzhou_list_url");
		     }
		     doc.append("listed", "1");
			 mongo.upsertDocByTableName(doc, "ajk_guangzhou_community_information");
		 }
	  cursor.close();
	}
}
