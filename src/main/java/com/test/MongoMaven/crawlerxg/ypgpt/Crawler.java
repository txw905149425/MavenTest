...
//			https://gpc.upchina.com/getInfoStagySingal?gscode=%E4%B8%BB%E9%A2%98%E9%BE%99%E5%A4%B4&ymd=20170503
			...
			String time=date.toString().substring(0, 4)+"-"+date.toString().substring(4, 6)+"-"+date.toString().substring(6, 8);
			...
			for(int j=1;j<=size;j++){
				...
				Object code=IKFunction.keyVal(two, "gpcode").toString().substring(2,8);
