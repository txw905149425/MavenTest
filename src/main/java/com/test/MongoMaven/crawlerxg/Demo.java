...
//		   MongoCollection<Document> mongo.getShardConn("xg_stock_last_json").deleteMany(Filters.exists("id"));
...
//		   }
		   mongo.getShardConn("xg_stock_last").deleteMany(Filters.exists("id"));
		   mongo.upsetManyMapByTableName(listOne, "xg_stock_last");
		   mongo.upsetManyMapByTableName(listOne, "xg_stock_last_all");
		} catch (Exception e) {
