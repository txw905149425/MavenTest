...
//		mongo.getShardConn("gd_weixin_by_gzh").deleteMany(Filters.exists("id"));
	try{	       
...
//					System.out.println(durl);
					if(durl.length()>10){
						...
						if(!ulist.isEmpty()){
							mongo.upsetManyMapByTableName(ulist, "gd_wx_gzh");
						}
...
//			map.put("url", durl);
	...
	public static boolean isTarge(String title){
		...
		String[] str={"股票精选","附股","推荐","股票池","牛股分享","核心参考"};
